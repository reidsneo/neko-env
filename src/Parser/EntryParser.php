...
final class EntryParser
{
     ...
     * @param string $line
     *
     * @return \Neko\Env\ResultType\Result<array{string,string|null},string>
     */
    private static function splitStringIntoParts(string $line)
    {
        ...
        /** @var \Neko\Env\ResultType\Result<array{string,string|null},string> */
     ...
     * @param string $value
     *
     * @return \Neko\Env\ResultType\Result<\Neko\Env\Parser\Value,string>
     */
     ...
     * @param string $token
     *
     * @return \Neko\Env\ResultType\Result<array{string,bool,int},string>
     */
    private static function processToken(int $state, string $token)
    {
        switch ($state) {
            case self::INITIAL_STATE:
                if ($token === '\'') {
                    /** @var \Neko\Env\ResultType\Result<array{string,bool,int},string> */
